<nav aria-hidden="true" class="menu" id="ui_menu" tabindex="-1">
    <div class="menu-scroll">
        <div class="menu-content">
            <a class="menu-logo" href="<?= Yii::$app->homeUrl; ?>">WPH Datacenter</a>
            <ul class="nav">
                <li>
                    ...
                    <ul class="menu-collapse collapse" id="ui_menu_components">
                        ...
                        <li>
                            <a class="waves-attach" href="ui-button-fab.html">Buttons
                                <small class="margin-left-xs">(Floating Action Button)</small>
                            </a>
                        </li>
                        <li>
