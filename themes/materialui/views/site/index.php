<?php
$this->title = "WPH Datacenter";
?>
<section class="content-inner margin-top-no">
    <div class="card">
        <div class="card-main">
            <div class="card-inner">
                <p>Daemonite's Material UI is a fully responsive, cross-platform, front-end interface
                    based on Google Material Design. This lightweight framework is built in HTML5 using
                    Bootstrap, JS and CSS.</p>
                <blockquote>A visual language for our users that synthesizes the classic principles of
                    good design with the innovation and possibility of technology and science. This is
                    material design.<sup class="margin-left-xs"><a
                            href="http://www.google.com/design/spec/material-design/introduction.html"
                            target="_blank"><span class="icon">open_in_new</span></a></sup></blockquote>
                <p>Have a play with this working prototype of Material, let us know what you think at
                    the <a href="http://labs.daemon.com.au" target="_blank">Daemon Labs<sup
                            class="margin-left-xs"><span class="icon">open_in_new</span></sup></a>
                    forum.</p>
            </div>
        </div>
    </div>
    <h2 class="content-sub-heading">Components</h2>
    <p>Below are components that have been defined by Material Design Guidelines. For more information,
        please visit <a href="https://www.google.com/design/spec/components/buttons.html"
                        target="_blank">Material Design Guidelines<sup class="margin-left-xs"><span
                    class="icon">open_in_new</span></sup></a>.</p>
    <div class="tile-wrap">
    ...
    <p>These components have not been specifically defined by Material Design Guidelines, but are used
        in some Google apps and/or sites.</p>
    <div class="tile-wrap">
    ...
    <p>Material includes several Bootstrap's Javascript plugins, <code>affix</code>,
        <code>collapse</code>, <code>dropdown</code>, <code>modal</code> &amp; <code>tab</code>, to be
        specific. For more information, please visit <a href="http://getbootstrap.com/javascript/"
                                                        target="_blank">Bootstrap Documentation Site<sup
                class="margin-left-xs"><span class="icon">open_in_new</span></sup></a>.</p>
    <div class="tile-wrap">
